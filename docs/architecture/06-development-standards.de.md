...
### 22.2 Svelte-Komponentenstandards
...
### 22.3 Datenbank-Standards

#### Prisma Schema Konventions
```prisma
// schema.prisma
generator client {
...
### 23.1 Richtlinien für Unit-Tests
...
## 24. Performance-Richtlinien

### 24.1 Frontend-Performance

Richtlinien zu **Bundle-Optimierung**, **Minifizierung**, **Assets**, **virtuellem Scrollen**, **Lazy Loading** und **debounced Search**.&#x20;
...
## 25. Entwicklungsstandards für Dashboard & Analytik

### 25.1 Interaktive Dashboard-Komponenten
...
### 25.2 Formularvalidierung & Änderungsdetektion
